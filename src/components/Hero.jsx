        ...
        <div className="flex flex-wrap items-center lg:flex-row flex-col-reverse">
          <div className="lg:w-1/2 w-full flex flex-col lg:items-start items-center lg:pb-20 mt-5 lg:mt-0">
            ...
            <div className="flex items-center mt-[33px] lg:text-start text-center">
              <button className="font-roboto flex items-start justify-center text-lg md:text-xl py-[14px] sm:px-[30px] px-[28px] bg-[#5B95E0] rounded-full text-white me-3 hover:shadow-[0px_4px_25px_0px_#FFC100] hover:bg-[#FFC100] hover:border hover:border-white border border-transparent">
                Free Trial
              </button>
              <button className="font-roboto flex items-start justify-center text-lg md:text-xl py-[14px] sm:px-[30px] px-[16px] bg-[#FFC100] rounded-full text-white shadow-[0px_4px_25px_0px_#FFC100] border border-white hover:border-transparent hover:bg-[#5B95E0] transition-all duration-300">
                Explore More
              </button>
            </div>
          </div>
