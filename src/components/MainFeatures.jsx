        ...
        <div className="container">
          <div className="flex flex-wrap justify-between lg:flex-row flex-col-reverse items-center">
            ...
            <div className="lg:w-[42%] w-full text-center lg:text-start">
              <h2 className=" text-3xl sm:text-4xl md:text-5xl font-medium text-[#12191F] font-roboto">
                Main Features
              </h2>
              <p className="text-sm md:text-base font-helveticaLight text-[#12191F] pt-4 text-opacity-70">
              ...
              <p className="text-sm md:text-base font-helveticaLight text-[#12191F] pt-2 text-opacity-70">
